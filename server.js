...
function sendmail(email,name,res)
{
	...
	var mailOptions = {
	  ...
	  html : '<div>Hi '+name+',</div><p> Thank you for Signing up. Please click the link below to verify your email address.</p><b><a href="http://www.discountedtrade.in/confirmemail?email='+email+'" return false;>Verification link</a></b>'
	};	
